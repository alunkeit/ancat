 ...
 * 
 */
public abstract class OutputTransformer
{
  abstract void addNode( Node n );

  abstract void addEdge( Edge e );

  abstract void transform() throws TransformationError;

  abstract StringBuffer getBuffer();

  public static OutputTransformer create( String type )
  {
    if( type.equalsIgnoreCase( "graphml" ) )
      return new GraphMLTransformer();
